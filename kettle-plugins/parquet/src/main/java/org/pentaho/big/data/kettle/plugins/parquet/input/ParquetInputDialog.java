...
import org.pentaho.di.ui.trans.steps.fileinput.BaseFileInputDialog;
import org.pentaho.di.ui.util.SwtSvgImageUtil;

public class ParquetInputDialog extends BaseFileInputDialog<ParquetInputMeta> {
  ...
  private void addFieldsTabs( CTabFolder wTabFolder ) {
    ...
    TableView wJobExecutorParameters =
    ...
    new FD( wJobExecutorParameters ).left( 0, 0 ).right( 100, 0 ).top( wIgnore, 10 ).bottom( wGetFields, -10 ).apply();
